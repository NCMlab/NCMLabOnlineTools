...
var AudioInstructions = [ 
		...
		{'page': '<p class="Instructions">For example, if you heard the digits <b style="color:blue;">one</b>, <b style="color:blue;">two</b>, '},
	    {'page': '<b style="color:blue;">three</b>, you would respond with <b style="color:blue;">1</b>, <b style="color:blue;">2</b>, <b style="color:blue;">3</b></p>'},
	    ];
