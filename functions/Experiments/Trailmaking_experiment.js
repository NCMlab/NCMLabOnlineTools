...
var FindCanvasSizeTest = {
  ...
  func: function () {
    sizes = FindCanvasSize(
      parameters.SuggestedWidth,
      parameters.SuggestedHeight,
      HeightAdjustment,
      WidthAdjustment
    );
...
var FindCanvasSizePractice = {
  ...
  func: function () {
    sizes = FindCanvasSize(
      parameters.PracticeSuggestedWidth,
      parameters.PracticeSuggestedHeight,
      0.95,
      0.75
    );
    PracticeCanvasWidth = sizes.CanvasWidth;
    PracticeCanvasHeight = sizes.CanvasHeight;
    console.log("==============================");
  },
};
...
var trial_Practice = {
  ...
  Circles: function () {
    return parameters.PracticeCircles;
  },
  ...
  change_circle_color_only_when_correct:
    parameters.change_circle_color_only_when_correct,
  ...
  extensions: [
    {
      ...
      params: {
        targets: ["#sketchpad-canvas"],
        events: ["mousemove", "mousedown", "mouseup"],
      },
    },
  ],
  finished_button_label: function () {
    return LabelNames.Finished;
  },
};
...
var trials = {
  ...
  change_circle_color_only_when_correct: function () {
    return parameters.change_circle_color_only_when_correct;
  },
  show_countdown_trial_duration: parameters.ShowTimer,
  trial_duration: parameters.Duration,
  first_circle_label: function () {
    return Instructions.FirstCircleLabel;
  },
  last_circle_label: function () {
    return Instructions.LastCircleLabel;
  },
  finished_button_label: function () {
    return LabelNames.Finished;
  },
...
var taskPrompt = {
  type: jsPsychHtmlButtonResponseTouchscreen,
  stimulus: function () {
    return Instructions.RealTaskPrompt[0].page;
  },
  post_trial_gap: 0,
  margin_horizontal: GapBetweenButtons,
  prompt: "PROMPT",
