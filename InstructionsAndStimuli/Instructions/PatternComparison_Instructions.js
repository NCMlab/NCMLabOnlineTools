...
var FR_Instructions = {}
FR_Instructions.Instructions01 = [{'page': '<p class="Instructions">Deux figures vous seront présentés. Si les chiffres sont les mêmes, appuyez sur <em>Mêmes</em>. Si elles sont différentes, appuyez sur <em>Différent</em>. Les séries d\'images changent rapidement, veuillez donc répondre aussi rapidement et précisément que possible.'
}]
FR_Instructions.Instructions02 = [{'page': '<p class="Instructions">Vous effectuerez quelques essais avec des retours pour vous entraîner.'}]
FR_Instructions.Instructions03 = [{'page': '<p class="Instructions">Vous allez maintenant commencer la véritable tâche sans rétroaction.'}]
FR_Instructions.WelcomeText = [{'page': '<p class="Instructions">Bienvenu(e) dans la tâche de comparaison de figures.'}]
