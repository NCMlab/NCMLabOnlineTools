...
EN_Instructions.Instructions01 = [
    ...
    {'page': ' Select one of the four cards displayed at the top of the screen such '+
    'that the selected card matches the card displayed at the bottom of the screen. '},
    {'page': ' You will be given feedback on whether the selected card was RIGHT or WRONG. Using this feedback, determine which dimension is targeted, and select the card accordingly. The targeted dimension may change from time to time without notice.'}
],
EN_Instructions.Instructions02 = [
    {'page': 'You will now perform a few practice trials.'}
]
EN_Instructions.Instructions03 = [
    {'page': 'You will now perform the actual task.'}
]
EN_Instructions.Debrief = [
    '<p>You responded correctly on ',
    '% of the trials.<p> with an average response time of ',
    ' ms']
EN_Instructions.ThankYouText = [{'page':'Thank you.'}]
EN_Instructions.DiscardPileText = 'Discard Pile'
EN_Instructions.WelcomeText = [{'page': 'This is the Card Sort Task.'}]
...
FR_Instructions.Instructions01 = [
    ...
    {'page': 'Sélectionnez l\'une des quatre cartes affichées en haut de l\'écran de telle sorte que la carte sélectionnée corresponde à la carte affichée en bas de l\'écran.'},
    {'page': 'Vous recevrez un retour indiquant si la carte sélectionnée était VRAIE ou FAUSSE. À l’aide de ces commentaires, déterminez quelle critères est ciblée et sélectionnez la carte en conséquence. Le critère ciblé peut changer de temps à autre sans préavis.'}
],
FR_Instructions.Instructions02 = [
    {'page': 'Vous allez maintenant effectuer quelques essais pratiques.'}
]
FR_Instructions.Instructions03 = [
    {'page': 'Vous allez maintenant effectuer la tâche réelle.'}
]
FR_Instructions.Debrief = [
    '<p>Vous avez  correctement répondu sur ',
    '% des essais.<p> avec un temps de réponse moyen de ',
    ' ms']
FR_Instructions.ThankYouText = [{'page':'Merci.'}]
FR_Instructions.DiscardPileText = 'La défausse'
FR_Instructions.WelcomeText = [{'page': 'Bienvenu(e) au test de tri de cartes multi-dimensionnelles.'}]
