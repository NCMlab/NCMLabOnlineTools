...
FR_Instructions_Default.Instructions01 = [
	...
	{'page': '<p class="Instructions">Vous allez maintenant entendre une deuxième liste de mots, c\'est la <b>Liste B</b>. Écoutez attentivement, car à la fin de la liste, vous devez répéter autant de mots dont vous vous souvenez. </p>'},
	{'page': '<p class="Instructions">Peu importe l\'ordre dans lequel vous les dites, dites simplement autant de mots dont vous pouvez vous souvenir, que vous les aviez dits ou pas avant.</p>'},
