...
EN_Instructions.WelcomeText = [{'page': '<p class="Instructions">Welcome to the Image Copying Task.'}]
...
FR_Instructions.WelcomeText = [{'page': '<p class="Instructions">Ceci est la tâche de copie du image. '}]
...
EN_ImageCopy_Instructions_FaCE.WelcomeText = [{'page': '<p class="Instructions">This is the Cube Copying Task. Press <b>Next</b> to Continue'}]
EN_ImageCopy_Instructions_FaCE.ThankYouText = [{'page': '<p class="Instructions">Thank you'}]
