...
EN_Instructions.Instructions01 = [
    {'page': '<p class="Instructions">This is to test that your computer sound is one and you can hear well.</p>'},
...
add('FR_Instructions_Default', function(){ Instructions = EN_Instructions});