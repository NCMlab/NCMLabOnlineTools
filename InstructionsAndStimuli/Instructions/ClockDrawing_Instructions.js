...
EN_Instructions.WelcomeText = [{'page': '<p class="Instructions">Welcome to the Clock Drawing Task.'}]
...
FR_Instructions.WelcomeText = [{'page': '<p class="Instructions">C\'est la tâche de dessin d\'horloge.'}]
