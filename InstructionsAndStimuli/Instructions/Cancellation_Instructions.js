var EN_Instructions = {}
EN_Instructions.WelcomeText = [{'page':'<p class="Instructions">Welcome to the Cancellation experiment.</p>'}]
...
add('EN_Cancellation_Instructions', function(){ Instructions = EN_Instructions});
...
add('FR_Cancellation_Instructions', function(){ Instructions = FR_Instructions});
