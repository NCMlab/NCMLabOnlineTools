...
add('EN_DigitSpan_Instructions_Default', function(){ Instructions = EN_Instructions});
add('FR_DigitSpan_Instructions_Default', function(){ Instructions = FR_Instructions});
