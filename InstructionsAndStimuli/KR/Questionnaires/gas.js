        ...
        elements: [
            { 
                ...
                rows: [
                    ...
                    {value: 'gas06', text: "나는 초조하고, 긴장되어 있거나 신경이 곤두선 느낌이었다."},
...
var KR_gas = {}
KR_gas.title = title
KR_gas.shortTitle = shortTitle
KR_gas.survey_JSON = survey_JSON
//EN_gasJSON.description = instructions
KR_gas.QuestionnaireType = 'matrix'
KR_gas.references = references
KR_gas.notes = notes