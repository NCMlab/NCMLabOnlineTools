...
\section{Scale}
This scale consists of a number of words that describe different feelings and emotions. Indicate to what extent you feel this way right now, that is, at the \underline{present moment}.
...
\begin{optiongroup}[colsep=5pt, rowsep=10pt]{}
    ...
    % \parbox[t]{2cm}{\centering ...} forces all column headers to the same
    %   2cm width so that columns are equal regardless of label length.
    ...
    \choice[val=0]{\parbox[t]{2cm}{\centering Very slightly or not at all}}
    \choice[val=1]{\parbox[t]{2cm}{\centering A little}}
    \choice[val=2]{\parbox[t]{2cm}{\centering Moderately}}
    \choice[val=3]{\parbox[t]{2cm}{\centering Quite a bit}}
    \choice[val=4]{\parbox[t]{2cm}{\centering Extremely}}
    ...
    \question[var=panas01]{Upset}
    \question[var=panas02]{Hostile}
    \question[var=panas03]{Alert}
    \question[var=panas04]{Ashamed}
    \question[var=panas05]{Inspired}
    \question[var=panas06]{Nervous}
    \question[var=panas07]{Determined}
    \question[var=panas08]{Attentive}
    \question[var=panas09]{Afraid}
    \question[var=panas10]{Active}
\end{optiongroup}
\end{questionnaire}
\end{document}
