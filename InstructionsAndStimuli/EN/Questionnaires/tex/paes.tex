...
\section{Scale}
Please rate how you feel \underline{at the moment} about the music and movement activity you have been doing.
...
\begin{optiongroup}[colsep=5pt, rowsep=10pt]{}
    ...
    \choice[val=1]{\parbox[t]{2cm}{\centering Strongly disagree}}
    \choice[val=2]{\parbox[t]{2cm}{\centering Disagree}}
    \choice[val=3]{\parbox[t]{2cm}{\centering Neither agree nor disagree}}
    \choice[val=4]{\parbox[t]{2cm}{\centering Agree}}
    \choice[val=5]{\parbox[t]{2cm}{\centering Strongly agree}}
    ...
    \question[var=paes001]{I enjoy it}
    \question[var=paes002]{I find it pleasurable}
    \question[var=paes003]{It is very pleasant}
    \question[var=paes004]{It feels good}
\end{optiongroup}
\end{questionnaire}
\end{document}
