...
\begin{optiongroup}[colsep=5pt, rowsep=10pt]{}
    ...
    % \parbox[t]{2.2cm}{\centering ...} forces all column headers to the same
    %   2.2cm width so that columns are equal regardless of label length.
    ...
    \choice[val=0]{\parbox[t]{2.2cm}{\centering Not at all}}
    \choice[val=1]{\parbox[t]{2.2cm}{\centering Sometimes}}
    \choice[val=2]{\parbox[t]{2.2cm}{\centering Most of the time}}
    \choice[val=3]{\parbox[t]{2.2cm}{\centering All of the time}}
