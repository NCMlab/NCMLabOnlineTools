var jsPsychInvestmentInstructions = (function (jspsych) {
  'use strict';
  ...
  /**
  * jspsych-investment-instructions
  * Sam Zorowitz
  *
  * plugin for running the instructions for the investment game
  *
  **/
  class InvestmentInstructionsPlugin {
    constructor(jsPsych) {
  ...
  InvestmentInstructionsPlugin.info = info;

  return InvestmentInstructionsPlugin;
