var jsPsychInvestmentTrial = (function (jspsych) {
  'use strict';
  ...
  /**
  * jspsych-investment-trial
  * Sam Zorowitz
  *
  * plugin for running a trial of the investment game
  *
  **/
  class InvestmentTrialPlugin {
    constructor(jsPsych) {
  ...
  InvestmentTrialPlugin.info = info;

  return InvestmentTrialPlugin;
