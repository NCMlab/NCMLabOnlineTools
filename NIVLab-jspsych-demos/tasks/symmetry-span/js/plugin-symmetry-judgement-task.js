var jsPsychSymmetryJudgmentTask = (function (jspsych) {
  'use strict';
  ...
  const info = {
    ...
    parameters: {
      ...
      size: {
        type: jspsych.ParameterType.INT, // INT, IMAGE, KEYCODE, STRING, FUNCTION, FLOAT
  ...
  */
  class SymmetryJudgmentTaskPlugin {
    constructor(jsPsych) {
  ...
  SymmetryJudgmentTaskPlugin.info = info;

  return SymmetryJudgmentTaskPlugin;
