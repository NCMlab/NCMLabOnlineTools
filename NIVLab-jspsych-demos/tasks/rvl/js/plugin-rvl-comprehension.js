var jsPsychRvlComprehension = (function (jspsych) {
  'use strict';

  const info = {
    name: 'rvl-comprehension',
    description: '',
    parameters: {
      button_label: {
  ...
  /**
  * jspsych-rvl-comprehension
  * Sam Zorowitz
  *
  * plugin for running the comprehension check of the RVL task instructions
  *
  **/
  class RvlComprehensionPlugin {
    constructor(jsPsych) {
  ...
  RvlComprehensionPlugin.info = info;

  return RvlComprehensionPlugin;
