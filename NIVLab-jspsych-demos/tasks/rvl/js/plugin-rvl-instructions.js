var jsPsychRvlInstructions = (function (jspsych) {
  'use strict';

  const info = {
    name: 'rvl-instructions',
    description: '',
    parameters: {
      pages: {
  ...
  /**
  * jspsych-rvl-instructions
  * Sam Zorowitz
  *
  * plugin for running the instructions for the RVL task
  *
  **/
  class RvlInstructionsPlugin {
    constructor(jsPsych) {
  ...
  RvlInstructionsPlugin.info = info;

  return RvlInstructionsPlugin;
