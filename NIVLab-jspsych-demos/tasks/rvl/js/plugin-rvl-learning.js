var jsPsychRvlLearning = (function (jspsych) {
  'use strict';
  ...
  /**
  * jspsych-rvl-learning
  * Sam Zorowitz
  *
  * plugin for running a learning trial of the RVL task
  *
  **/
  class RvlLearningPlugin {
    constructor(jsPsych) {
  ...
  RvlLearningPlugin.info = info;

  return RvlLearningPlugin;
