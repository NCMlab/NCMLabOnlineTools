var jsPsychRvlPractice = (function (jspsych) {
  'use strict';
  ...
  /**
  * jspsych-rvl-practice
  * Sam Zorowitz
  *
  * plugin for running a practice block of the RVL task
  *
  **/
  class RvlPracticePlugin {
    constructor(jsPsych) {
    ...
    trial(display_element, trial) {
      ...
      var after_response = function(info) {
        ...
        jsPsych.pluginAPI.setTimeout(function() {
          present_feedback(response);
        }, trial.robot_duration);

      };

      // function to end trial when it is time
      var present_feedback = function(response) {
  ...
  RvlPracticePlugin.info = info;

  return RvlPracticePlugin;
