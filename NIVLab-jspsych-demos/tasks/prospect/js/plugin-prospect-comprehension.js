var jsPsychProspectComprehension = (function (jspsych) {
  'use strict';

  const info = {
    name: 'prospect-comprehension',
    description: '',
    parameters: {
      button_label: {
  ...
  class ProspectComprehensionPlugin {
    constructor(jsPsych) {
  ...
  ProspectComprehensionPlugin.info = info;

  return ProspectComprehensionPlugin;
