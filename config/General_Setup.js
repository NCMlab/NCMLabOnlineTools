...
EN_LabelNames.SubmitAnyway = 'Submit with unanswered questions'
EN_LabelNames.SubmitAnywayAreYouSure = 'You have chosen to submit without answering all questions. Are you sure?'
EN_LabelNames.Done = 'Done'
EN_LabelNames.Other = 'Other (describe)'
...
FR_LabelNames.SubmitAnyway = 'Soumettre avec des questions sans réponse'
FR_LabelNames.SubmitAnywayAreYouSure = 'You have chosen to submit without answering all questions. Are you sure?'
...
FR_LabelNames.Other = 'Autre (décrire)'
...
KR_LabelNames.Clear = '지우세요'
KR_LabelNames.Undo = '해제'
KR_LabelNames.Redo = '다시 하다'
KR_LabelNames.Repeat = '반복하다'
KR_LabelNames.Next = '다음' 
KR_LabelNames.Continue = '계속하다'
KR_LabelNames.Previous = '이전의'
KR_LabelNames.Enter = '입력하다'
KR_LabelNames.Submit = '제출하다'
KR_LabelNames.SubmitAnyway = '답변하지 못한 질문이 있으면 양식을 제출해 주세요'
KR_LabelNames.SubmitAnywayAreYouSure = 'You have chosen to submit without answering all questions. Are you sure?'
...
KR_LabelNames.Different = 'Different'
