...
var parameters009 = []
var List = []
List.push({name: 'xDemographics',   battery: '98701', row: 1, BitIndex: 1, Phase: "Eligibility"})
List.push({name: 'xMRI Safety',     battery: '98702', row: 1, BitIndex: 2, Phase: "Eligibility"})
List.push({name: 'xQVieActive',     battery: '98703', row: 1, BitIndex: 3, Phase: "Eligibility"})
List.push({name: 'xADL-PD',         battery: '98704', row: 1, BitIndex: 4, Phase: "Eligibility"})
List.push({name: 'CompExp',         battery: '98705', row: 1, BitIndex: 5, Phase: "Eligibility"})
List.push({name: 'xVideoExp',        battery: '98706', row: 1, BitIndex: 6, Phase: "Eligibility"})
List.push({name: 'xCCI',         battery: '98711', row: 3, BitIndex: 7, Phase: "Health"})
List.push({name: 'xFRS',         battery: '98712', row: 3, BitIndex: 8, Phase: "Health"})
List.push({name: 'xWH',          battery: '98713', row: 3, BitIndex: 9, Phase: "Health"})
List.push({name: 'GAI',         battery: '98714', row: 3, BitIndex: 10, Phase: "Health"})
List.push({name: 'GDS',          battery: '98715', row: 3, BitIndex: 11, Phase: "Health"})
List.push({name: 'xCRQ',          battery: '98721', row: 5, BitIndex: 12, Phase: "Moderators"})
List.push({name: 'xLTPAQ',        battery: '98722', row: 5, BitIndex: 13, Phase: "Moderators"})
List.push({name: 'xNASA-TLX-1',    battery: '98751', row: 7, BitIndex: 14, Phase: "Workload"})
List.push({name: 'xNASA-TLX-2',    battery: '98751', row: 7, BitIndex: 15, Phase: "Workload"})
List.push({name: 'xNASA-TLX-3',    battery: '98751', row: 7, BitIndex: 16, Phase: "Workload"})
List.push({name: 'xNASA-TLX-4',    battery: '98751', row: 7, BitIndex: 17, Phase: "Workload"})
List.push({name: 'Semaine 1',   battery: '98713', row: 9, BitIndex: 18, Phase: 'Weekly', Test: 1})// sleep/ipaq/cog_quot
List.push({name: 'Semaine 2',   battery: '98713', row: 9, BitIndex: 19, Phase: 'Weekly', Test: 2})
List.push({name: 'Semaine 3', battery:  '98713', row: 9, BitIndex: 20, Phase: 'Weekly', Test: 3})
List.push({name: 'Semaine 4', battery:  '98713', row: 9, BitIndex: 21, Phase: 'Weekly', Test: 4})
List.push({name: 'Semaine 5', battery:  '98713', row: 10, BitIndex: 22, Phase: 'Weekly', Test: 5})
List.push({name: 'Semaine 6', battery:  '98713', row: 10, BitIndex: 23, Phase: 'Weekly', Test: 6})
List.push({name: 'Semaine 7', battery:  '98713', row: 10, BitIndex: 24, Phase: 'Weekly', Test: 7})
List.push({name: 'Semaine 8', battery:  '98713', row: 10, BitIndex: 25, Phase: 'Weekly', Test: 8})
List.push({name: 'Semaine 9', battery:  '98713', row: 11, BitIndex: 26, Phase: 'Weekly', Test: 9})
List.push({name: 'Semaine 10', battery: '98713', row: 11, BitIndex: 27, Phase: 'Weekly', Test: 10})
List.push({name: 'Semaine 11', battery: '98713', row: 11, BitIndex: 28, Phase: 'Weekly', Test: 11})
List.push({name: 'Semaine 12', battery: '98713', row: 11, BitIndex: 29, Phase: 'Weekly', Test: 12})
List.push({name: 'Semaine 13', battery: '98713', row: 12, BitIndex: 30, Phase: 'Weekly', Test: 13})
List.push({name: 'Semaine 14', battery: '98713', row: 12, BitIndex: 31, Phase: 'Weekly', Test: 14})
List.push({name: 'Semaine 15', battery: '98713', row: 12, BitIndex: 32, Phase: 'Weekly', Test: 15})
List.push({name: 'Semaine 16', battery: '98713', row: 12, BitIndex: 33, Phase: 'Weekly', Test: 16})
List.push({name: 'Semaine 17', battery: '98713', row: 13, BitIndex: 34, Phase: 'Weekly', Test: 17})
List.push({name: 'Semaine 18', battery: '98713', row: 13, BitIndex: 35, Phase: 'Weekly', Test: 18})
List.push({name: 'Semaine 19', battery: '98713', row: 13, BitIndex: 36, Phase: 'Weekly', Test: 19})
List.push({name: 'Semaine 20', battery: '98713', row: 13, BitIndex: 37, Phase: 'Weekly', Test: 20})
List.push({name: 'Semaine 21', battery: '98713', row: 14, BitIndex: 38, Phase: 'Weekly', Test: 21})
List.push({name: 'Semaine 22', battery: '98713', row: 14, BitIndex: 39, Phase: 'Weekly', Test: 22})
List.push({name: 'Semaine 23', battery: '98713', row: 14, BitIndex: 40, Phase: 'Weekly', Test: 23})
List.push({name: 'Semaine 24', battery: '98713', row: 14, BitIndex: 41, Phase: 'Weekly', Test: 24})
