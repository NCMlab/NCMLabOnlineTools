...
KR_List.push({name: 'Baseline 1', battery: '77', row: 2, BitIndex: 4})
KR_List.push({name: 'Baseline 2', battery: '77', row: 2, BitIndex: 5})
KR_List.push({name: 'Baseline 3', battery: '77', row: 2, BitIndex: 6})
KR_List.push({name: 'Baseline Trails 1', battery: '78', row: 3, BitIndex: 7})
KR_List.push({name: 'Baseline Trails 2', battery: '83', row: 3, BitIndex: 8})
KR_List.push({name: 'Baseline Trails 3', battery: '84', row: 3, BitIndex: 9})
KR_List.push({name: 'Week 1, Pre', battery: '75', row: 4, BitIndex: 10})
KR_List.push({name: 'Week 1, Post', battery: '76', row: 4, BitIndex: 11})
KR_List.push({name: 'Week 2, Pre', battery: '80', row: 5, BitIndex: 12})
KR_List.push({name: 'Week 2, Post', battery: '76', row: 5, BitIndex: 13})
KR_List.push({name: 'Week 3, Pre', battery: '81', row: 6, BitIndex: 14})
KR_List.push({name: 'Week 3, Post', battery: '76', row: 6, BitIndex: 15})
KR_List.push({name: 'Week 4, Pre', battery: '75', row: 7, BitIndex: 16})
KR_List.push({name: 'Week 4, Post', battery: '76', row: 7, BitIndex: 17})
KR_List.push({name: 'Week 5, Pre', battery: '80', row: 8, BitIndex: 18})
KR_List.push({name: 'Week 5, Post', battery: '76', row: 8, BitIndex: 19})
KR_List.push({name: 'Week 6, Pre', battery: '81', row: 9, BitIndex: 20})
KR_List.push({name: 'Week 6, Post', battery: '76', row: 9, BitIndex: 21})
KR_List.push({name: 'Week 7, Pre', battery: '75', row: 10, BitIndex: 22})
KR_List.push({name: 'Week 7, Post', battery: '76', row: 10, BitIndex: 23})
KR_List.push({name: 'Week 8, Pre', battery: '80', row: 11, BitIndex: 24})
KR_List.push({name: 'Week 8, Post', battery: '76', row: 11, BitIndex: 25})
KR_List.push({name: 'Week 9, Pre', battery: '81', row: 12, BitIndex: 26})
KR_List.push({name: 'Week 9, Post', battery: '76', row: 12, BitIndex: 27})
KR_List.push({name: 'Week 10, Pre', battery: '82', row: 13, BitIndex: 28})
KR_List.push({name: 'Week 10, Post', battery: '76', row: 13, BitIndex: 29})
KR_List.push({name: 'Post-intervention 1', battery: '78', row: 14, BitIndex: 30})
KR_List.push({name: 'Post-intervention 2', battery: '78', row: 14, BitIndex: 31})
KR_List.push({name: 'Post-intervention 3', battery: '78', row: 14, BitIndex: 32})
KR_List.push({name: 'Post-intervention Trails 1', battery: '78', row: 15, BitIndex: 33})
KR_List.push({name: 'Post-intervention Trails 2', battery: '78', row: 15, BitIndex: 34})
KR_List.push({name: 'Post-intervention Trails 3', battery: '78', row: 15, BitIndex: 35})
KR_List.push({name: 'Week 11, Pre', battery: '75', row: 17, BitIndex: 36})
KR_List.push({name: 'Week 11, Post', battery: '76', row: 17, BitIndex: 37})
KR_List.push({name: 'Week 12, Pre', battery: '75', row: 18, BitIndex: 38})
KR_List.push({name: 'Week 12, Post', battery: '76', row: 18, BitIndex: 39})
KR_List.push({name: 'Week 13, Pre', battery: '75', row: 19, BitIndex: 40})
KR_List.push({name: 'Week 13, Post', battery: '76', row: 10, BitIndex: 41})
KR_List.push({name: 'Pick a Test', battery: '79', row: 20, BitIndex: 42, ButtonUsageType: 'UserChoice'})
