...
List.push({name: 'Week 11, Pre', battery: '75', row: 16, BitIndex: 28})
List.push({name: 'Week 11, Post', battery: '76', row: 16, BitIndex: 29})
List.push({name: 'Week 12, Pre', battery: '75', row: 17, BitIndex: 28})
List.push({name: 'Week 12, Post', battery: '76', row: 17, BitIndex: 29})
List.push({name: 'Week 13, Pre', battery: '75', row: 18, BitIndex: 28})
List.push({name: 'Week 13, Post', battery: '76', row: 18, BitIndex: 29})
List.push({name: 'Pick a Test', battery: '72', row: 19, BitIndex: 30, ButtonUsageType: 'UserChoice'})
