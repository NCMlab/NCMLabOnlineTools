...
var parameters009 = []
var List = []
List.push({name: 'MRI Safety',  battery: '98701', row: 1, BitIndex: 1})
List.push({name: 'PARQ',        battery: '98702', row: 1, BitIndex: 2})
List.push({name: 'ADL-PD',      battery: '98703', row: 1, BitIndex: 3})
List.push({name: 'Demographics', battery: '98704', row: 1, BitIndex: 4})
List.push({name: 'CCI',         battery: '98705', row: 2, BitIndex: 5})
List.push({name: 'FRS',         battery: '98706', row: 2, BitIndex: 6})
List.push({name: 'WH',          battery: '98707', row: 2, BitIndex: 7})
List.push({name: 'GAI',         battery: '98708', row: 2, BitIndex: 8})
List.push({name: 'GDS',         battery: '98709', row: 3, BitIndex: 9})
...
List.push({name: 'Semaine 1',   battery: '98713', row: 5, BitIndex: 13})
