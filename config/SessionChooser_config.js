...
List.push({name: 'Week 1, Post', battery: '80', row: 4, BitIndex: 11})
List.push({name: 'Week 2, Pre', battery: '75', row: 5, BitIndex: 12})
List.push({name: 'Week 2, Post', battery: '81', row: 5, BitIndex: 13})
List.push({name: 'Week 3, Pre', battery: '75', row: 6, BitIndex: 14})
List.push({name: 'Week 3, Post', battery: '82', row: 6, BitIndex: 15})
List.push({name: 'Week 4, Pre', battery: '75', row: 7, BitIndex: 16})
List.push({name: 'Week 4, Post', battery: '80', row: 7, BitIndex: 17})
List.push({name: 'Week 5, Pre', battery: '75', row: 8, BitIndex: 18})
List.push({name: 'Week 5, Post', battery: '81', row: 8, BitIndex: 19})
List.push({name: 'Week 6, Pre', battery: '75', row: 9, BitIndex: 20})
List.push({name: 'Week 6, Post', battery: '82', row: 9, BitIndex: 21})
List.push({name: 'Week 7, Pre', battery: '75', row: 10, BitIndex: 22})
List.push({name: 'Week 7, Post', battery: '80', row: 10, BitIndex: 23})
List.push({name: 'Week 8, Pre', battery: '75', row: 11, BitIndex: 24})
List.push({name: 'Week 8, Post', battery: '81', row: 11, BitIndex: 25})
List.push({name: 'Week 9, Pre', battery: '75', row: 12, BitIndex: 26})
List.push({name: 'Week 9, Post', battery: '82', row: 12, BitIndex: 27})
List.push({name: 'Week 10, Pre', battery: '75', row: 13, BitIndex: 28})
List.push({name: 'Week 10, Post', battery: '85', row: 13, BitIndex: 29})
List.push({name: 'Post-intervention 1', battery: '77', row: 14, BitIndex: 30})
List.push({name: 'Post-intervention 2', battery: '77', row: 14, BitIndex: 31})
List.push({name: 'Post-intervention 3', battery: '77', row: 14, BitIndex: 32})
