...
List.push({name: 'Week 11, Pre', battery: '75', row: 17, BitIndex: 28})
List.push({name: 'Week 11, Post', battery: '76', row: 17, BitIndex: 29})
List.push({name: 'Week 12, Pre', battery: '75', row: 18, BitIndex: 28})
List.push({name: 'Week 12, Post', battery: '76', row: 18, BitIndex: 29})
List.push({name: 'Week 13, Pre', battery: '75', row: 19, BitIndex: 28})
List.push({name: 'Week 13, Post', battery: '76', row: 10, BitIndex: 29})
List.push({name: 'Pick a Test', battery: '79', row: 20, BitIndex: 30, ButtonUsageType: 'UserChoice'})
