...
var parameters009 = []
var List = []
List.push({name: 'xMRI Safety',  battery: '98701', row: 1, BitIndex: 1})
List.push({name: 'PARQ',        battery: '98702', row: 1, BitIndex: 2})
List.push({name: 'xADL-PD',      battery: '98703', row: 1, BitIndex: 3})
List.push({name: 'xDemographics', battery: '98704', row: 1, BitIndex: 4})
List.push({name: 'CCI',         battery: '98705', row: 2, BitIndex: 5})
List.push({name: 'Comp Exp',    battery: '98706', row: 2, BitIndex: 6})
List.push({name: 'xWH',          battery: '98707', row: 2, BitIndex: 7})
List.push({name: 'xGAI',         battery: '98708', row: 2, BitIndex: 8})
List.push({name: 'GDS',         battery: '98709', row: 2, BitIndex: 9})
List.push({name: 'CRQ',         battery: '98710', row: 3, BitIndex: 10})
List.push({name: 'LTPAQ',       battery: '98711', row: 3, BitIndex: 11})
//List.push({name: 'IPAQ',        battery: '98712', row: 3, BitIndex: 12})
List.push({name: 'NASA-TLX-1',    battery: '98712', row: 4, BitIndex: 12})
List.push({name: 'NASA-TLX-2',    battery: '98712', row: 4, BitIndex: 12})
List.push({name: 'NASA-TLX-3',    battery: '98712', row: 4, BitIndex: 12})
List.push({name: 'NASA-TLX-4',    battery: '98712', row: 4, BitIndex: 12})
List.push({name: 'Semaine 1',   battery: '98713', row: 5, BitIndex: 13})// sleep/ipaq/cog_quot
List.push({name: 'Semaine 2',   battery: '98713', row: 5, BitIndex: 14})
List.push({name: 'Semaine 3', battery:  '98713', row: 5, BitIndex: 15})
List.push({name: 'Semaine 4', battery:  '98713', row: 5, BitIndex: 16})
List.push({name: 'Semaine 5', battery:  '98713', row: 6, BitIndex: 17})
List.push({name: 'Semaine 6', battery:  '98713', row: 6, BitIndex: 18})
List.push({name: 'Semaine 7', battery:  '98713', row: 6, BitIndex: 19})
List.push({name: 'Semaine 8', battery:  '98713', row: 6, BitIndex: 20})
List.push({name: 'Semaine 9', battery:  '98713', row: 7, BitIndex: 21})
List.push({name: 'Semaine 10', battery: '98713', row: 7, BitIndex: 22})
List.push({name: 'Semaine 11', battery: '98713', row: 7, BitIndex: 23})
List.push({name: 'Semaine 12', battery: '98713', row: 7, BitIndex: 24})
List.push({name: 'Semaine 13', battery: '98713', row: 8, BitIndex: 25})
List.push({name: 'Semaine 14', battery: '98713', row: 8, BitIndex: 26})
List.push({name: 'Semaine 15', battery: '98713', row: 8, BitIndex: 27})
List.push({name: 'Semaine 16', battery: '98713', row: 8, BitIndex: 28})
List.push({name: 'Semaine 17', battery: '98713', row: 9, BitIndex: 29})
List.push({name: 'Semaine 18', battery: '98713', row: 9, BitIndex: 30})
List.push({name: 'Semaine 19', battery: '98713', row: 9, BitIndex: 31})
List.push({name: 'Semaine 20', battery: '98713', row: 9, BitIndex: 32})
List.push({name: 'Semaine 21', battery: '98713', row: 10, BitIndex: 29})
List.push({name: 'Semaine 22', battery: '98713', row: 10, BitIndex: 30})
List.push({name: 'Semaine 23', battery: '98713', row: 10, BitIndex: 31})
List.push({name: 'Semaine 24', battery: '98713', row: 10, BitIndex: 32})
List.push({name: 'Pick a Test', battery: '98799', row: 10, BitIndex: 99, ButtonUsageType: 'UserChoice'})
