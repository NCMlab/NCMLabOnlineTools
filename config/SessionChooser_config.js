...
EN_List.push({name: 'Week 13, Post', battery: '82', row: 19, BitIndex: 41, Phase: 'Post-class', Test: '13'})
...
FR_List.push({name: 'Semaine 13, Post', battery: '82', row: 19, BitIndex: 41, Phase: 'Post-class', Test: '13'})
...
KR_List.push({name: '1주차, Post', battery: '80', row: 4, BitIndex: 11})
KR_List.push({name: '2주차, Pre', battery: '75', row: 5, BitIndex: 12})
KR_List.push({name: '2주차, Post', battery: '80', row: 5, BitIndex: 13})
KR_List.push({name: '3주차, Pre', battery: '75', row: 6, BitIndex: 14})
KR_List.push({name: '3주차, Post', battery: '81', row: 6, BitIndex: 15})
KR_List.push({name: '4주차, Pre', battery: '75', row: 7, BitIndex: 16})
KR_List.push({name: '4주차, Post', battery: '80', row: 7, BitIndex: 17})
KR_List.push({name: '5주차, Pre', battery: '75', row: 8, BitIndex: 18})
KR_List.push({name: '5주차, Post', battery: '81', row: 8, BitIndex: 19})
KR_List.push({name: '6주차, Pre', battery: '75', row: 9, BitIndex: 20})
KR_List.push({name: '6주차, Post', battery: '82', row: 9, BitIndex: 21})
KR_List.push({name: '7주차, Pre', battery: '75', row: 10, BitIndex: 22})
KR_List.push({name: '7주차, Post', battery: '80', row: 10, BitIndex: 23})
KR_List.push({name: '8주차, Pre', battery: '75', row: 11, BitIndex: 24})
KR_List.push({name: '8주차, Post', battery: '81', row: 11, BitIndex: 25})
KR_List.push({name: '9주차, Pre', battery: '75', row: 12, BitIndex: 26})
KR_List.push({name: '9주차, Post', battery: '82', row: 12, BitIndex: 27})
KR_List.push({name: '10주차, Pre', battery: '75', row: 13, BitIndex: 28})
KR_List.push({name: '10주차, Post', battery: '85', row: 13, BitIndex: 29})
...
KR_List.push({name: '11주차, Post', battery: '80', row: 17, BitIndex: 37})
KR_List.push({name: '12주차, Pre', battery: '75', row: 18, BitIndex: 38})
KR_List.push({name: '12주차, Post', battery: '81', row: 18, BitIndex: 39})
KR_List.push({name: '13주차, Pre', battery: '75', row: 19, BitIndex: 40})
KR_List.push({name: '13주차, Post', battery: '82', row: 19, BitIndex: 41})
...
List.push({name: 'Semaine 1',   battery: '98713', row: 10, BitIndex: 19, Phase: 'Weekly', Test: 1})// sleep/ipaq/cog_quot
List.push({name: 'Semaine 2',   battery: '98713', row: 10, BitIndex: 20, Phase: 'Weekly', Test: 2})
List.push({name: 'Semaine 3', battery:  '98713', row: 10, BitIndex: 21, Phase: 'Weekly', Test: 3})
List.push({name: 'Semaine 4', battery:  '98713', row: 10, BitIndex: 22, Phase: 'Weekly', Test: 4})
List.push({name: 'Semaine 5', battery:  '98713', row: 11, BitIndex: 23, Phase: 'Weekly', Test: 5})
List.push({name: 'Semaine 6', battery:  '98713', row: 11, BitIndex: 24, Phase: 'Weekly', Test: 6})
List.push({name: 'Semaine 7', battery:  '98713', row: 11, BitIndex: 25, Phase: 'Weekly', Test: 7})
List.push({name: 'Semaine 8', battery:  '98713', row: 11, BitIndex: 26, Phase: 'Weekly', Test: 8})
List.push({name: 'Semaine 9', battery:  '98713', row: 12, BitIndex: 27, Phase: 'Weekly', Test: 9})
List.push({name: 'Semaine 10', battery: '98713', row: 12, BitIndex: 28, Phase: 'Weekly', Test: 10})
List.push({name: 'Semaine 11', battery: '98713', row: 12, BitIndex: 29, Phase: 'Weekly', Test: 11})
List.push({name: 'Semaine 12', battery: '98713', row: 12, BitIndex: 30, Phase: 'Weekly', Test: 12})
List.push({name: 'Semaine 13', battery: '98713', row: 13, BitIndex: 31, Phase: 'Weekly', Test: 13})
List.push({name: 'Semaine 14', battery: '98713', row: 13, BitIndex: 32, Phase: 'Weekly', Test: 14})
List.push({name: 'Semaine 15', battery: '98713', row: 13, BitIndex: 33, Phase: 'Weekly', Test: 15})
List.push({name: 'Semaine 16', battery: '98713', row: 13, BitIndex: 34, Phase: 'Weekly', Test: 16})
List.push({name: 'Semaine 17', battery: '98713', row: 14, BitIndex: 35, Phase: 'Weekly', Test: 17})
List.push({name: 'Semaine 18', battery: '98713', row: 14, BitIndex: 36, Phase: 'Weekly', Test: 18})
List.push({name: 'Semaine 19', battery: '98713', row: 14, BitIndex: 37, Phase: 'Weekly', Test: 19})
List.push({name: 'Semaine 20', battery: '98713', row: 14, BitIndex: 38, Phase: 'Weekly', Test: 20})
List.push({name: 'Semaine 21', battery: '98713', row: 15, BitIndex: 39, Phase: 'Weekly', Test: 21})
List.push({name: 'Semaine 22', battery: '98713', row: 15, BitIndex: 40, Phase: 'Weekly', Test: 22})
List.push({name: 'Semaine 23', battery: '98713', row: 15, BitIndex: 41, Phase: 'Weekly', Test: 23})
List.push({name: 'Semaine 24', battery: '98713', row: 15, BitIndex: 42, Phase: 'Weekly', Test: 24})
