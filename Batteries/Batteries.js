...
BatteryList.push({index: 15, 
	name:'FaCE Battery', 
	list: ['Word Recall','Trail Making','Cube Copy','Serial Subtraction','Fluency','Word Recall','Intake Form'],
	list: ['Trail Making','Cube Copy','Serial Subtraction','Fluency','Word Recall','Intake Form'],
	description: 'A web-based version of the FaCE',
	ParameterLists: ['TrailMaking_FaCE','CubeCopy_Default','SerialSubtract_FaCE','Fluency_FruitsVegetable','FaCE_Default_Delayed','EN_IntakeForm_FaCE'],
	Instructions: ['FaCE','FaCE','Default','Default','Default','Default'],
	Instructions: ['FaCE','Default','Default','Default','Default'],
