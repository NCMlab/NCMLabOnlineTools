...
List.push({Task: 'Word Recall', Parameters: 'DemoENManual', Instructions: 'Default', IconName: 'Imm Recall (Manual)'})
...
BatteryList.push({index: 74, 
	...
	description: '',
	TaskList: List,
	BatteryInstructions: "<h1>Music and Motion Study -- Baseline</h1>",
	Language:'EN',
	RunAudioTest: true,
	Footer: '©NCMLab 2024'
})
...
BatteryList.push({index: 75, 
	...
	description: '',
	TaskList: List,
	BatteryInstructions: "<h1>Music and Motion Study -- Weekly Pre</h1>",
	Language:'EN',
	RunAudioTest: true,
	Footer: '©NCMLab 2024'
})
...
BatteryList.push({index: 76, 
	...
	description: '',
	TaskList: List,
	BatteryInstructions: "<h1>Music and Motion Study -- Weekly Post</h1>",
	Language:'EN',
	RunAudioTest: true,
	Footer: '©NCMLab 2024'
})
