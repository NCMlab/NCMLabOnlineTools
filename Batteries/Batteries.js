...
BatteryList.push({index: 15, 
	...
	list: ['Image Copy','Serial Subtraction','Fluency','Word Recall','Intake Form'],
	...
	ParameterLists: ['ImageCopy_FaCE','SerialSubtract_FaCE','Fluency_FruitsVegetable','FaCE_Default_Delayed','EN_IntakeForm_FaCE'],
	Instructions: ['FaCE','FaCE','Default','Default','Default','Default'],
	Instructions: ['FaCE','Default','Default','Default'],
