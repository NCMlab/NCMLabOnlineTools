...
List.push({
  ...
  IconName: "Email Entry",
});
List.push({
  Task: "Ending Page",
  Parameters: "",
  Instructions: "Default",
  IconName: "Ending Page",
});
...
List.push({
  Task: "Spatial DMS",
  Parameters: "SpatialDMS_Adaptive",
  Instructions: "Default",
  IconName: "Dots",
});
List.push({
...
List.push({
  Task: "Intake Form",
  Parameters: "IntakeForm_FR",
  Instructions: "Default",
  IconName: "Intake",
});
List.push({
  Task: "Listening",
  Parameters: "Listening_002",
  Instructions: "Default",
  IconName: "Listening",
});
List.push({
...
List.push({
  Task: "Word Recall",
  Parameters: "RAVLT_Spoken_Immediate_002",
  Instructions: "Default",
  IconName: "Immediate",
});
List.push({
...
List.push({
  Task: "Word Recall",
  Parameters: "RAVLT_Spoken_Delayed_002",
  Instructions: "Default",
  IconName: "Delayed",
});
List.push({
  Task: "Word Recognition",
  Parameters: "WordRecog_Spoken_002",
  Instructions: "Default",
  IconName: "Recognition",
});
List.push({
...
BatteryList.push({
  ...
  description: "Test",
  BatteryInstructions:
    "<p class=\"Instructions\">Bienvenu(e) au Laboratoire de carte cognitive cerebrale de l'Université d'Ottawa - <b>Évaluation cognitive</b>",
  Language: "FR",
  RunAudioTest: true,
  Footer: "©NCMLab 2025",
  TaskList: List,
...
List.push({
  ...
  Parameters: "SerialSubtract_Default",
  Instructions: "Default",
  IconName: "Subtract",
});
List.push({
  Task: "Fluency",
  Parameters: "Fluency_Animals",
  Instructions: "Default",
...
List.push({
  Task: "Card Sort",
  Parameters: "CardSort_002",
  Instructions: "Default",
  IconName: "Card Sort",
});
List.push({
  Task: "Pattern Comparison",
  Parameters: "PatternComparison_002",
  Instructions: "Default",
  IconName: "Pattern Comparison",
});
List.push({
  Task: "Cancellation Task",
  Parameters: "Cancellation_001",
...
List.push({
  ...
  Parameters: "MatrixReasoning_ICAR",
  Instructions: "Default",
  IconName: "Matrix Reas",
});
List.push({
  Task: "Digit Span",
  Parameters: "DigitSpan_Audio_Forward_TwoErrors",
...
FaCE_Training_Spoken_EN_List.push({
  Task: "Word Recall",
  Parameters: "FaCE_Immediate_Spoken_Training_EN",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_Training_Spoken_EN_List.push({
  Task: "Trail Making",
  Parameters: "TrailMaking_FaCE_Training",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_Training_Spoken_EN_List.push({
...
FaCE_Training_Spoken_EN_List.push({
  Task: "Serial Subtraction",
  Parameters: "SerialSubtract_FaCE_Training_Spoken",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_Training_Spoken_EN_List.push({
  Task: "Fluency",
  Parameters: "FaCE_Training_Spoken",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_Training_Spoken_EN_List.push({
  Task: "Word Recall",
  Parameters: "FaCE_Delayed_Spoken_Training_EN",
  Instructions: "FaCE",
  IconName: "",
});
// 				Manual
...
FaCE_VerB_Spoken_EN_List.push({
  Task: "Word Recall",
  Parameters: "FaCE_Immediate_Spoken_VerB_EN",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_VerB_Spoken_EN_List.push({
...
FaCE_VerB_Spoken_EN_List.push({
  Task: "Serial Subtraction",
  Parameters: "SerialSubtract_FaCE_VerB_Spoken",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_VerB_Spoken_EN_List.push({
  Task: "Fluency",
  Parameters: "FaCE_VerB_Spoken",
  Instructions: "FaCE",
  IconName: "",
});
FaCE_VerB_Spoken_EN_List.push({
  Task: "Word Recall",
  Parameters: "FaCE_Delayed_Spoken_VerB_EN",
  Instructions: "FaCE",
  IconName: "",
});
// 				Manual
...
List.push({
  Task: "Screening",
  Parameters: "BriefScreening_DEMO",
  Instructions: "",
  IconName: "Screening",
});
List.push({
...
List.push({
  Task: "Trail Making",
  Parameters: "TrailMaking_Demonstration",
  Instructions: "Demo",
  IconName: "",
});
List.push({
  Task: "Cancellation Task",
  Parameters: "Cancellation_Demo",
  Instructions: "Default",
  IconName: "Cancellation",
});
List.push({
...
BatteryList.push({
  ...
  TaskList: List,
  BatteryInstructions:
    "<h1>A demonstration of cognitive and behavioral assessments</h1>",
  Language: "EN",
  RunAudioTest: true,
  Footer: "©NCMLab 2025",
});
...
List.push({
  ...
  Parameters: "DemoEN",
  Instructions: "Default",
  IconName: "Imm Recall (Spoken)",
});
List.push({
  Task: "Word Recall",
  Parameters: "DemoENManual",
  Instructions: "Default",
  IconName: "Imm Recall (Manual)",
});
List.push({
  Task: "Trail Making",
  Parameters: "TrailMaking_Demonstration",
...
// The IconName and the shortTitle need to match to show up correctly in the ReactJS site
  ...
  BatteryList.push({index: 72, 
    ...
    shortName: "First Name", // Do not change this name since it is used later
		description: '',
		TaskList: List,
...
BatteryList.push({
  index: 80,
  name: "Music Motion: Post Weeks 1, 4, 7",
  shortName: "weeklyPost147",
  description: "",
  TaskList: List,
  BatteryInstructions: "<h1>Music and Motion Study</h1>",
  Language: "EN",
...
BatteryList.push({
  index: 81,
  name: "Music Motion: Post Weeks 2, 5, 8",
  shortName: "weeklyPost258",
  description: "",
  TaskList: List,
  BatteryInstructions: "<h1>Music and Motion Study</h1>",
  Language: "EN",
...
BatteryList.push({
  index: 82,
  name: "Music Motion: Post Weeks 3, 6, 9 ",
  shortName: "weeklyPost369",
  description: "",
  TaskList: List,
  BatteryInstructions: "<h1>Music and Motion Study</h1>",
  Language: "EN",
