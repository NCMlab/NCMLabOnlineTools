...
BatteryList.push({index: 1001, 
	name:'TESTER', 
	list: ['Consent Form','Questionnaire','Reading Test','Word Recall', 'Word Recall', 'Word Recognition'],
	//list: ['Intake Form'],
	description: 'Test',
	ParameterLists: ['EN_ConsentForm_uOttawa_Steffener','EN_IntakeForm_Generic','ReadingListeningList01','RAVLT_Spoken_Immediate', 'RAVLT_Spoken_Delayed', 'TEST_Spoken'],
	//ParameterLists: ['EN_IntakeForm_FaCE'],
