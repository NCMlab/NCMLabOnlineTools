var jsPsychImageButtonResponsePatternComp = (function (jspsych) {
  'use strict';
  ...
  class ImageButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          var height, width;
          var correct
        trial.NTrials = trial.stimulus[0].length
          var end_time = 0
          var rt = 0
          ...
          function after_response(choice) {
              ...
              response.rt.push(rt);
              response.correct.push(trial.stimulus[2][count])
              response.load.push(trial.stimulus[3][count])
              
                console.log(choice)
                console.log(trial.stimulus[2][count])
                ...
                setTimeout(function(){
                    ...
                    document.getElementById("jspsych-image-button-response-stimulus-0").src =  trial.stimulus[0][count];
                    document.getElementById("jspsych-image-button-response-stimulus-1").src =  trial.stimulus[1][count];
