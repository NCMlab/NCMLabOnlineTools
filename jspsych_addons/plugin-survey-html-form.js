      ...
      trial(display_element, trial) {
          ...
          console.log("==== PREPARING THE HTML ====")
            for ( var page = 0; page < NPages; page++ ) {
                ...
                // For each page I need to check to see if it is the last page and if not add a NEXT button
          html += Str
                if ( page == NPages -1 )
                {
// add submit button
...
// add NEXT button
            html += '<div class="tableSubmitButton">'
            html +=
              '<table border="0"><tr><td colspan="2"><input type="next" id="jspsych-survey-matrix-next" onClick="InternalValidateForm(this.form)" class="jspsych-survey-matrix jspsych-btn submit-btn" value="' +
                'NEXT' +
                ' "></input>';
            html += "</form></td><td colspan='3' class='item_label' id='tableMessageBox' style='display: none'>"+trial.missed_question_text+"</td></tr></table>";
                }
