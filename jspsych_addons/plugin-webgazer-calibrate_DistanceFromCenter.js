var jsPsychWebgazerCalibrate = (function (jspsych) {
  ...
  class WebgazerCalibratePlugin {
      ...
      trial(display_element, trial) {
          var html = `
          <div id='webgazer-calibrate-container' style='position: relative; width:80vw; height:80vh'>
          </div>`;
...
//              var pt_html = `<div id="calibration-point" style="width:${trial.point_size}px; height:${trial.point_size}px; border-radius:${trial.point_size}px; border: 1px solid #000; background-color: #333; position: absolute; left:${pt[0]}%; top:${pt[1]}%;"></div>`;
              var pt_html = `<div id="calibration-point" style="width:${trial.point_size}px; height:${trial.point_size}px; border-radius:${trial.point_size}px; border: 1px solid #000; background-color: #333; position: absolute;bottom: 50%;left: 50%;margin-left:${pt[0]}px; margin-bottom:${pt[1]}px;"></div>`;
//              var pt_html = '<div style="font-size:'+DMSFontSize+'px; position: absolute;bottom: 50%;left: 50%;margin-left: -'+WidthFromCenter+'px;margin-bottom: '+HeightFromCenter+'px;" id="TrackingTarget_TL">'+Letters[0][0]+'</div>'
  ...
  WebgazerCalibratePlugin.info = info;
