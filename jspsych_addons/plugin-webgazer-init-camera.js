  ...
  class WebgazerInitCameraPlugin {
      ...
      trial(display_element, trial, on_load) {
        ...
        `;
          ...
          <div id='webgazer-init-container' style='position: relative; width:80vw; height:80vh'>
          </div>`;
          ...
          <div style='position: absolute; top: max(260px, 40%); left: calc(50% - 300px); width:600px;'>
          ${trial.instructions}
