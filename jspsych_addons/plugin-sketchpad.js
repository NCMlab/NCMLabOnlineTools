  ...
  class SketchpadPlugin {
      ...
      `;
          ...
          if (this.params.show_finished_button) {
              sketchpad_controls += `<button class="jspsych-btn" id="sketchpad-end">${this.params.finished_button_label}</button>`;
          }
          ...
          if (this.params.prompt !== null) {
              if (this.params.prompt_location == "abovecanvas") {
                  display_html = this.params.prompt + timer_html + canvas_html;
              }
              if (this.params.prompt_location == "belowcanvas") {
                  display_html = timer_html + canvas_html + this.params.prompt;
              }
              ...
              display_html = timer_html + canvas_html;
          }
