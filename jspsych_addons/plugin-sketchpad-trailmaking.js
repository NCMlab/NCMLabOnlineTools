      ...
      trial(display_element, trial, on_load) {
          ...
          for (var i = 0; i < this.params.Circles .length; i++){
            ...
            if ( i < 3 & i > 0) {
                ...
                this.add_arrowHead(this.params.Circles[i-1].centerX, this.params.Circles[i-1].centerY, this.params.Circles[i].centerX, this.params.Circles[i].centerY,this.params.Circles[i].radius)
